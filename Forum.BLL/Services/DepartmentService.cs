...
namespace ReportService.BLL.Services
{
    public class DepartmentService : IDepartmentService
    {
        ...
        public async Task<Departments> GetDepartmentByIdAsync(int id)
        {
            ...
            return await _unitOfWork.DepartmentsRepository.GetByIdAsync(id);
        }
        ...
        public async Task<int> AddDepartmentAsync(Departments department)
        {
            ...
            return await _unitOfWork.DepartmentsRepository.AddAsync(department);
        }
        ...
        public async Task UpdateDepartmentAsync(int id, Departments department)
        {
            ...
            var existingDepartment = await _unitOfWork.DepartmentsRepository.GetByIdAsync(id);
            if (existingDepartment != null)
            {
                // Виконати оновлення департаменту
                existingDepartment.Name = department.Name;
                await _unitOfWork.DepartmentsRepository.UpdateAsync(existingDepartment);
            }
        }
        ...
        public async Task DeleteDepartmentAsync(int id)
        {
            ...
            await _unitOfWork.DepartmentsRepository.DeleteAsync(id);
        }
    }
}
